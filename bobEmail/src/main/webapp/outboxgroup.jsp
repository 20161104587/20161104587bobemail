...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">发件箱</strong> / <small>Table</small></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
         <!--  foreach循环 -->
         	<c:forEach items="${outboxgroup }" var="inlist" >
            <tr>
              <td><a href="#">群发邮件</a></td>
              <td><a href="${pageContext.request.contextPath}/userController/checkemail.do?emailid=${inlist.mailid}&userid=${User.id}&type=outbox" target="_Self">${inlist.title}</a></td>
             ...
             <td>
     <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger" onclick="window.location.href = '${pageContext.request.contextPath}/userController/checkmailgroupreply.do?emailid=${inlist.mailid}&userid=${User.id}'">查看邮件恢复状态</button>
