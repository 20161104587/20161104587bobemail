  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/userController/updatedepartmentinformation.do?deppid=${dep.depid }" method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">部门名称 / depname</label>
            <div class="am-u-sm-9">
              <input type="text" id="depname" placeholder="部门名称 / Name" name="depname" value=${dep.depname }>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="depdes" placeholder="部门描述 / Email" name="depdes" value=${dep.depdes }>
              <small>邮箱你懂得...</small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="deprole" placeholder="部门角色 / Telephone" name="deprole" value=${dep.deprole }>
            </div>
          </div>
