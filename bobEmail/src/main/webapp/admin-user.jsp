  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/userController/updateuserinformation" method="post">
          <div class="am-form-group">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="deparmentid" placeholder="输入你密码" name="deparmentid">
            </div>
          </div>
            ...
            <div class="am-u-sm-9">
              <input type="password" id="pwd" placeholder="输入你的部门id号码"  name="pwd">
            </div>
          </div>
            <div class="am-form-group">
            <label for="user-QQ" class="am-u-sm-3 am-form-label"></label>
            <div class="am-u-sm-9">
              <input type="hidden"  placeholder="输入你的部门id号码"  name="id" value="${User.id}">
            </div>
          </div>
