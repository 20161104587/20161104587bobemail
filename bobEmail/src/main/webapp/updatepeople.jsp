  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/userController/updatepeopleinformation.do?userid=${updateuser.id}" method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 / Name</label>
            <div class="am-u-sm-9">
              <input type="text" id="truename" placeholder="姓名 / Name" name="truename" value=${updateuser.truename }>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="email" id="email" placeholder="输入你的电子邮件 / Email" name="email" value=${updateuser.email }>
              <small>邮箱你懂得...</small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="tel" placeholder="输入你的电话号码 / Telephone" name="tel" value=${updateuser.tel }>
            </div>
          </div>

          <div class="am-form-group">
            <label for="user-QQ" class="am-u-sm-3 am-form-label">部门id</label>
            <div class="am-u-sm-9">
              <input type="text" id="deparmentid" placeholder="输入你密码" name="deparmentid" value=${updateuser.deparmentid }>
            </div>
          </div>
            ...
            <div class="am-u-sm-9">
              <input type="password" id="pwd" placeholder="输入你的部门id号码"  name="pwd" value=${updateuser.pwd }>
            </div>
          </div>
               <div class="am-form-group">
            <label for="user-QQ" class="am-u-sm-3 am-form-label">管理员</label>
            <div class="am-u-sm-9">
              <input type="text" id="isadmins" placeholder="是否设置管理员"  name="isadmins" value=${updateuser.isadmin }>
            </div>
          </div>
