...
function del(id,obj){
	...
	$.ajax({
	type:"POST",
	url:'${pageContext.request.contextPath}/userController/deletepeople.do',
	data:{'id':id},
	dataType:'text',
	success:function(){	
		  alert("成功拉");
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-type">用户姓名</th><th class="table-title">用户密码</th><th class="table-type">用户性别</th><th class="table-type">用户电话</th><th class="table-type">用户邮箱</th><th class="table-type">所属部门</th><th class="table-type">是否管理员</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
         
         	<c:forEach items="${user }" var="inlist" >
            <tr>
              ...
              <td>${inlist.isadmin}</td>
             <td>
     <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger" onclick="window.location.href = '${pageContext.request.contextPath}/userController/updatepeople.do?id=${inlist.id}'"><span class="am-icon-trash-o"></span> 修改</button>
     <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger" onclick="del(${inlist.id},this);"><span class="am-icon-trash-o"></span> 删除</button>
